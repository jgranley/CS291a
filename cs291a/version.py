...
description = "CS291a: Closed loop optimization of prosthetic vision with deep learning"
...
.. _README: https://github.com/uwescience/cs291a/blob/master/README.md

License
=======
``CS291a`` is licensed under the terms of the MIT license. See the file
...
URL = "https://github.com/jgranley/CS291a"
DOWNLOAD_URL = ""
LICENSE = "MIT"
...
VERSION = __version__
PACKAGE_DATA = {'cs291a': [pjoin('data', '*')]}
